...
Warning: When authenticating, browser can sometimes get stuck for 1 minute because the
interface is not up yet. This can help: `sudo dscacheutil -flushcache && sudo
killall -HUP mDNSResponder`. Permanent solution is to use `/etc/hosts` I guess.
